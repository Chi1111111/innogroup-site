...
$files = @('scripts/japan-market-local-service.mjs', 'scripts/sync-japancars-japan-market.mjs', 'scripts/lib/japancars.mjs', 'scripts/lib/japan-market-cloud.mjs', 'scripts/lib/japan-market-changes.mjs', 'scripts/lib/japan-market-seen.mjs', 'src/data/japanMarketQuality.mjs')
