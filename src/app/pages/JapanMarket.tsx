  ...
  return <main className="japan-market">
    ...
    <div className="jm-shell jm-workspace">
      ...
      <div className="jm-results" ref={results}>
        ...
        <details className="jm-about-data"><summary>{text({ en: 'About these listings & landed estimates', zh: '车源及落地价说明' })}</summary><p>{text({ en: 'These vehicle listings are not auction results. Estimates may change with exchange rates, shipping, compliance and vehicle condition. We confirm availability, condition and final costs before you commit.', zh: '这些车源并非拍卖结果。预计落地价会受汇率、运费、合规和实际车况影响。购买前我们会再次确认库存、车况与最终费用。' })}</p></details>
